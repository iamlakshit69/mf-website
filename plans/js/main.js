...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ===================================================
     9. KOMPAKT CARD — price counter on scroll-in
  =================================================== */
  ...
  /* ===================================================
     11. TRUST STRIP — stagger on reveal
  =================================================== */
...
/* =====================================================
   CTA STATE SYNC — button content + href swaps
   on payment tab toggle
===================================================== */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const states = {
    "1": {
      href:      "Checkout/upfront/upfront.html",
    ...
    "2": {
      href:      "Checkout/installments/installments.html",
  ...
  function syncCTA(tabIndex) {
    ...
    /* Swap href — routes to correct checkout page */
    btn.setAttribute("href", s.href);
